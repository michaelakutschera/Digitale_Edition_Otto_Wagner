...
<xsl:stylesheet version="1.0"
        ...
        <html lang="de">
            ...
            <body>
                ...
                <main>
                    ...
                    <div id="pdf-panel">
                        <iframe id="pdf-frame" src="../pdf/Letzter_Wille_1888.pdf#page=1"></iframe>
                    </div>
    ...
    <xsl:template match="tei:fw[@type='archival']">
        <xsl:variable name="rendClass">
            <xsl:if test="@rend"> fw-<xsl:value-of select="translate(@rend, ' ', '-')"/></xsl:if>
        </xsl:variable>
        <span class="fw-archival{$rendClass}">
            <xsl:apply-templates/>
        </span>
    </xsl:template>
    ...
    <xsl:template match="tei:fw[@type='shownThrough']">
        <span class="fw-type-shownThrough">[<xsl:apply-templates/>]</span>
    </xsl:template>
