...
•	Welche Personen treten neu auf, welche verschwinden?
...
Otto Wagners berufliche Situation bis 1873-1876: 
...
Für die Datein personen.xml, orte.xml, organisationen.xml undn events.xml werden folgende Regeln genutzt:

*Personen:*
pe_Nachname: pe_wagner, pe_rainer, pe_foerster etc.

pe_AnfangsbuchsabenVorname_Nachname: pe_sus_wagner, pe_eme_wagner etc.

--> Wegen gleichem Nachnamen bei der Familie Wagner. 

*Orte:*
pl_Stadt: pl_wien, pl_berlin, pl_baden
